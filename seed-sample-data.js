...
(async function SEED() {
  ...
  // ── INTERACTIONS ──────────────────────────────────────────────────────
  // Note: equityFormSubmitted was moved to the meeting/event level. Do NOT put it here.
  const newInteractions = [
    // US-89
    { id: uid(), projectId: p1, stakeholderId: s[4],  date: '2025-01-10', channel: 'Email',        direction: 'Outgoing',  nepaStage: 'EA - Draft',    summary: 'Transmitted Draft EA to FHWA Utah Division for federal review. Document includes traffic, noise, air quality, and EJ technical analyses. 45-day review period initiated.', followUp: true,  followUpNote: 'Follow up on FHWA review comments by February 24', followUpDue: '2025-02-24', followUpDone: false, loggedBy: 'A. Stratton' },
    { id: uid(), projectId: p1, stakeholderId: s[1],  date: '2025-02-05', channel: 'Public meeting',direction: 'In-person', nepaStage: 'EA - Draft',    summary: 'Attended Tongan community meeting at Layton Pacific Islander Cultural Center with Peni Fifita. 42 community members present. Presented bilingual project fact sheet. Top concerns: noise during nighttime paving, pedestrian crossing safety at US-89/Gordon Ave, and air quality during construction. Tongan interpreter provided throughout.', followUp: true, followUpNote: 'Translate Q&A summary into Tongan and distribute via Taufa contact list', followUpDue: '2025-02-19', followUpDone: true, loggedBy: 'J. Putzke' },
    { id: uid(), projectId: p1, stakeholderId: s[6],  date: '2025-02-12', channel: 'Email',        direction: 'Incoming',  nepaStage: 'EA - Draft',    summary: 'Allred submitted formal written noise wall ballot petition signed by 187 Layton Hills residents. Requests UDOT initiate noise barrier eligibility determination before Draft EA public comment period closes.', followUp: true, followUpNote: 'Forward to UDOT noise team for eligibility review. Respond to Allred in writing within 10 business days.', followUpDue: '2025-02-26', followUpDone: false, loggedBy: 'J. Putzke' },
    { id: uid(), projectId: p1, stakeholderId: s[2],  date: '2025-03-03', channel: 'In-person',    direction: 'In-person', nepaStage: 'EA - Draft',    summary: 'Pre-hearing briefing with Rep. Romero at the Capitol. Presented EJ analysis summary and LEP outreach metrics. Rep. Romero expressed support for Tongan-language outreach efforts and asked for final EJ findings before the public hearing.', followUp: true, followUpNote: 'Send final EJ summary to Rep. Romero office 2 weeks before public hearing', followUpDue: '2025-04-14', followUpDone: false, loggedBy: 'J. Putzke' },
    { id: uid(), projectId: p1, stakeholderId: s[3],  date: '2025-03-18', channel: 'Phone',        direction: 'Incoming',  nepaStage: 'EA - Draft',    summary: "Jensen called to flag conflict with Farmington City's planned water main replacement on 400 N US-89. Requesting coordination meeting to align construction schedules and avoid simultaneous utility conflicts.", followUp: true, followUpNote: 'Schedule joint coordination meeting with Farmington City Engineering and UDOT Region 1', followUpDue: '2025-04-01', followUpDone: true, loggedBy: 'J. Putzke' },
    { id: uid(), projectId: p1, stakeholderId: s[20], date: '2025-01-22', channel: 'Email',        direction: 'Outgoing',  nepaStage: 'EA - Draft',    summary: 'Submitted Title VI compliance checklist and LEP outreach summary for Draft EA public hearing to Tina Morales, UDOT Civil Rights. Includes documentation of Tongan-language materials and interpretation services arranged for community meeting on Feb 5.', followUp: false, followUpNote: '', followUpDue: null, followUpDone: false, loggedBy: 'J. Putzke' },
    // SR-97
    { id: uid(), projectId: p2, stakeholderId: s[10], date: '2025-04-14', channel: 'Email',        direction: 'Outgoing',  nepaStage: 'Post-NEPA / Construction', summary: 'Distributed April construction update to Springville Chamber distribution list (1,400 members). Included detour map, business access hotline number, and May/June lane closure schedule. Harrop confirmed receipt and plans to share in Chamber e-newsletter.', followUp: false, followUpNote: '', followUpDue: null, followUpDone: false, loggedBy: 'J. Putzke' },
    { id: uid(), projectId: p2, stakeholderId: s[9],  date: '2025-05-06', channel: 'In-person',    direction: 'In-person', nepaStage: 'Post-NEPA / Construction', summary: 'Monthly project briefing with Mayor Oyler and City Administrator. Presented construction progress, upcoming Phase 2 Main St closure dates, and public communication plan. Mayor requested that the city be notified 48 hours before any press releases about delays.', followUp: true, followUpNote: "Add Mayor's office to 48-hour advance notification list for all delay announcements", followUpDue: '2025-05-09', followUpDone: true, loggedBy: 'J. Putzke' },
    { id: uid(), projectId: p2, stakeholderId: s[11], date: '2025-05-11', channel: 'Phone',        direction: 'Outgoing',  nepaStage: 'Post-NEPA / Construction', summary: 'Called Sister Petersen to confirm Phase 2 paving schedule. Confirmed no work on Sundays or Wednesday evenings 6–9 PM throughout Phase 2. Petersen expressed appreciation and offered parking lot as staging area during off-hours.', followUp: false, followUpNote: '', followUpDue: null, followUpDone: false, loggedBy: 'J. Putzke' },
    { id: uid(), projectId: p2, stakeholderId: s[12], date: '2025-05-20', channel: 'Email',        direction: 'Incoming',  nepaStage: 'Post-NEPA / Construction', summary: 'Vance emailed formal request for aesthetic construction screening on Main St frontage adjacent to the museum entrance. Attached examples of screening wraps used on other Utah DOT projects. Copied Mayor Oyler and Chamber director.', followUp: true, followUpNote: 'Review screening request with UDOT Region 3 RE and contractor. Respond to Vance within 5 days.', followUpDue: '2025-05-27', followUpDone: false, loggedBy: 'J. Putzke' },
    { id: uid(), projectId: p2, stakeholderId: s[13], date: '2025-04-07', channel: 'Public meeting',direction: 'In-person', nepaStage: 'Post-NEPA / Construction', summary: 'Pre-construction public open house at Springville High School. Contreras attended with 14 Spanish-speaking residents from the 400 South corridor. Spanish interpreter on site. Residents raised pedestrian safety concerns at 400 South crossing during construction. Comment cards collected (bilingual).', followUp: true, followUpNote: 'Prepare Spanish-language response to pedestrian safety comments. Distribute via Contreras.', followUpDue: '2025-04-21', followUpDone: true, loggedBy: 'J. Putzke' },
    // Carbon County
    { id: uid(), projectId: p3, stakeholderId: s[14], date: '2024-02-14', channel: 'Mail',         direction: 'Outgoing',  nepaStage: 'EA - Scoping',  summary: 'Sent formal written tribal notification to Ute Indian Tribe THPO per UDOT 08A2-07 and Utah EO 2014/005. Letter describes project corridor, potential impacts to traditional cultural properties, and request for consultation. Certified mail, return receipt requested.', followUp: true, followUpNote: 'Follow up by March 14 if no response received (30-day deadline)', followUpDue: '2024-03-14', followUpDone: true, loggedBy: 'A. Stratton' },
    { id: uid(), projectId: p3, stakeholderId: s[14], date: '2024-03-20', channel: 'Phone',        direction: 'Incoming',  nepaStage: 'EA - Scoping',  summary: 'Received call from Nathan Begay, THPO. Tribe acknowledges receipt of notification. Requests site visit and Phase I cultural resources survey results before formal consultation meeting. Two areas of concern: lower Price River canyon and a ridge above Helper city limits identified as traditional use area.', followUp: true, followUpNote: 'Schedule site visit with Begay. Confirm Phase I survey scope with Amy.', followUpDue: '2024-04-05', followUpDone: true, loggedBy: 'A. Stratton' },
    { id: uid(), projectId: p3, stakeholderId: s[16], date: '2024-06-03', channel: 'Phone',        direction: 'Incoming',  nepaStage: 'EA - Scoping',  summary: "Mayor Schofield called expressing frustration about project hold. Concerned Helper residents see no visible project activity. Requested a status letter he can share publicly and a community meeting before year-end even if project schedule hasn't advanced.", followUp: true, followUpNote: 'Draft project status letter for Helper City. Check with UDOT on authorized messaging during hold period.', followUpDue: '2024-06-17', followUpDone: true, loggedBy: 'J. Putzke' },
    { id: uid(), projectId: p3, stakeholderId: s[17], date: '2024-05-20', channel: 'Public meeting',direction: 'In-person', nepaStage: 'EA - Scoping',  summary: 'NEPA scoping meeting at Carbon County Courthouse. Archuleta attended with 7 Helper residents. Voiced concerns about disproportionate construction impacts on lower-income Hispanic households near the Helper interchange. Submitted written comment requesting EJ analysis begin immediately.', followUp: true, followUpNote: 'Acknowledge written EJ comment in scoping report. Begin EJ demographic analysis.', followUpDue: '2024-06-10', followUpDone: true, loggedBy: 'J. Putzke' }
  ];

  // ── MEETINGS ──────────────────────────────────────────────────────────
  // attendeeIds uses temp stakeholder UIDs — remapped below after stakeIdMap is built.
  // equityFormSubmitted: true on any public meeting where equity/civil rights form was completed.
  const newMeetings = [
    {
      id: uid(), projectId: p1,
      title: 'US-89 NEPA Scoping Meeting — Public',
      date: '2024-07-23', type: 'Public open house', status: 'Completed',
      location: 'Layton City Hall Council Chambers, 437 N Wasatch Dr, Layton, UT',
      format: 'In-person',
      attendanceCount: 134, commentCards: 52,
      attendeeIds: [s[1], s[2], s[3], s[4], s[5], s[6], s[7], s[18], s[20]],
      additionalAttendees: 'General public (~125 community members, Layton Hills residents, local business owners)',
      equityFormSubmitted: true,
      handouts: 'Bilingual project fact sheet (English/Tongan), alternatives map, comment card',
      agenda: 'Present project need, alternatives, and environmental study process. Collect public input on preferred alternative and key concerns.',
      keyConcerns: 'Noise impacts on Layton Hills residential area. Tongan community concerns about pedestrian safety and air quality. Business owners requesting access maintenance during paving. Noise wall interest from 150+ households.',
      actionItems: 'Provide Tongan Q&A summary to Marcus Taufa\nInitiate noise barrier eligibility study for Layton Hills segment\nDistribute scoping comment summary within 60 days',
      notes: 'Tongan interpreter provided. Spanish materials available. Mayor Cragun gave opening remarks. Strong turnout exceeded room capacity — overflow standing room.',
      createdAt: '2024-07-23T18:00:00.000Z'
    },
    {
      id: uid(), projectId: p1,
      title: 'US-89 Draft EA Public Hearing',
      date: '2025-04-28', type: 'Public hearing', status: 'Planned',
      location: 'Layton Community Center, 465 N Wasatch Dr, Layton, UT',
      format: 'In-person + Virtual hybrid',
      attendanceCount: 0, commentCards: 0,
      attendeeIds: [],
      additionalAttendees: '',
      equityFormSubmitted: false,
      handouts: 'Draft EA executive summary, alternatives comparison, noise study summary, EJ analysis, Tongan fact sheet',
      agenda: 'Present Draft EA findings. Accept formal oral and written comments for the record. Court reporter on-site.',
      keyConcerns: '',
      actionItems: 'Confirm Tongan/Spanish interpreters\nNotify Rep. Romero 2 weeks in advance\nSubmit Title VI pre-meeting checklist to Tina Morales',
      notes: 'Scheduled per NEPA requirement. 30-day comment period closes May 28.',
      createdAt: '2025-01-15T09:00:00.000Z'
    },
    {
      id: uid(), projectId: p2,
      title: 'SR-97 Pre-Construction Public Open House',
      date: '2025-04-07', type: 'Public open house', status: 'Completed',
      location: 'Springville High School Commons, 545 S 200 E, Springville, UT',
      format: 'In-person',
      attendanceCount: 89, commentCards: 31,
      attendeeIds: [s[8], s[9], s[10], s[11], s[12], s[13], s[18], s[20]],
      additionalAttendees: 'General public (~81 downtown business owners and Main St area residents)',
      equityFormSubmitted: true,
      handouts: 'Construction schedule, detour map, business access plan, bilingual Spanish/English fact sheet',
      agenda: 'Introduce project team, present construction timeline and phasing, explain traffic management plan, Q&A',
      keyConcerns: 'Business access on Main St during Phase 2 closure. Pedestrian safety at 400 South during construction. Construction hours sensitivity for LDS Chapel and Springville Museum. Aesthetic screening request from Art Museum.',
      actionItems: 'Distribute business access hotline to Chamber\nPrepare Spanish-language response to pedestrian safety comments\nFollow up with Museum on screening options',
      notes: 'Spanish interpreter on site. Bilingual comment cards collected. Strong business community attendance. Mayor Oyler gave opening welcome.',
      createdAt: '2025-04-07T17:30:00.000Z'
    },
    {
      id: uid(), projectId: p3,
      title: 'I-15 Carbon County Access Study — NEPA Scoping',
      date: '2024-05-20', type: 'Public open house', status: 'Completed',
      location: 'Carbon County Courthouse, 120 E Main St, Price, UT',
      format: 'In-person',
      attendanceCount: 47, commentCards: 19,
      attendeeIds: [s[14], s[15], s[16], s[17], s[18], s[19]],
      additionalAttendees: 'Carbon County Business Alliance members, Wellington and Helper residents (~41)',
      equityFormSubmitted: true,
      handouts: 'Study purpose & need summary, project area map, comment card, EJ fact sheet',
      agenda: 'Present study purpose, scope, and NEPA process. Solicit input on community priorities and potential alternatives.',
      keyConcerns: 'Local economic development vs. environmental impacts in Price River corridor. EJ concerns from Helper residents. Tribal cultural resource concerns noted by Ute Indian Tribe representative (written comment submitted separately). Access timing and funding timeline uncertainty.',
      actionItems: 'Acknowledge EJ comment in scoping report\nInitiate EJ demographic analysis for Helper area\nBegin Phase I cultural resources survey coordination with SHPO and Ute Tribe',
      notes: 'Attendee mix included county officials, Helper and Wellington residents, Carbon County Business Alliance, and Archuleta coalition members. Project on hold announced at meeting end — disappointment noted.',
      createdAt: '2024-05-20T17:00:00.000Z'
    }
  ];

  // ── COMMENT PERIODS ───────────────────────────────────────────────────
  // Comment periods use text PKs (app-generated uid) — id is preserved as-is.
  ...
  // ── PUBLIC COMMENTS ───────────────────────────────────────────────────
  // Internal field name is 'periodId' (maps to Supabase 'period_id').
  const newComments = [
    // US-89 (cp1)
  ...
  // Tribal consultations use text PKs (app-generated uid).
  const newTribal = [
    {
      id: uid(), projectId: p3,
      tribeName: 'Ute Indian Tribe of the Uintah and Ouray',
      tribeType: 'Federally Recognized',
      tribalOfficial: 'Nathan Begay',
      tribalOfficialEmail: 'nbegay@utetribe.com',
      tribalOfficialPhone: '(435) 722-5141',
      thpoContact: 'Nathan Begay',
      thpoEmail: 'nbegay@utetribe.com',
      thpoPhone: '(435) 722-5141',
      agencyOfficial: 'Amy Stratton',
      fhwaLiaison: 'Diana Lucero',
      consultationType: 'Section 106',
      consultationTrigger: 'EA initiation — potential impacts to traditional cultural properties in project corridor',
      section106Phase: 'Initiation',
      notificationDate: '2024-02-14',
      responseDeadline: '2024-03-14',
      responseDate: '2024-03-20',
      responseStatus: 'Response received — site visit requested',
      nearTribalLands: true,
      cfr710Review: false,
      moaRequired: false,
      biaInvolvement: false,
      languageAccessNeeded: false,
      includedInAnnualReport: false,
      nextAction: 'Schedule site visit with Begay. Provide Phase I cultural resources survey results. Formal consultation meeting to follow project restart.',
      followUpDate: '2024-04-05',
      notes: 'Formal written notification sent per UDOT 08A2-07 and Utah EO 2014/005. Tribe identified two areas of concern: (1) lower Price River canyon and (2) ridge above Helper city limits, used as traditional cultural properties. Project currently on hold — formal consultation meeting pending funding reauthorization.'
    }
  ];
  ...
  const remapPS    = newPS.map(r => ({
    ...r,
    projectId:     projIdMap[r.projectId]  || r.projectId,
    stakeholderId: stakeIdMap[r.stakeholderId] || r.stakeholderId
  }));
  const remapInts  = newInteractions.map(r => ({
    ...r,
    projectId:     projIdMap[r.projectId]  || r.projectId,
    stakeholderId: stakeIdMap[r.stakeholderId] || r.stakeholderId
  }));
  const remapMeet  = newMeetings.map(r => ({
    ...r,
    projectId:   projIdMap[r.projectId] || r.projectId,
    attendeeIds: (r.attendeeIds || []).map(sid => stakeIdMap[sid] || sid)
  }));
  const remapPer   = newPeriods.map(r => ({
    ...r,
    projectId: projIdMap[r.projectId] || r.projectId
  }));
  const remapCmts  = newComments.map(r => ({
    ...r,
    projectId:           projIdMap[r.projectId] || r.projectId,
    linkedStakeholderId: r.linkedStakeholderId ? stakeIdMap[r.linkedStakeholderId] || r.linkedStakeholderId : null
  }));
  const remapDels  = newDeliverables.map(r => ({
    ...r,
    projectId: projIdMap[r.projectId] || r.projectId
  }));
  const remapTribal = newTribal.map(r => ({
    ...r,
    projectId: projIdMap[r.projectId] || r.projectId
  }));
  ...
  console.log('Inserting tribal consultations...');
  await Promise.all(remapTribal.map(r => sbAdd('tribal_consultations', r)));
...
Stakeholders:          ${newStakeholders.length}  (${newStakeholders.filter(s=>s.lep).length} LEP · ${newStakeholders.filter(s=>s.underserved).length} EJ/underserved)
Project links:         ${newPS.length}
Interactions:          ${newInteractions.length}
Meetings:              ${newMeetings.length}  (${newMeetings.filter(m=>m.equityFormSubmitted).length} with equity form submitted)
Comment periods:       ${newPeriods.length}  (EA-30DAY + CE-10DAY)
Public comments:       ${newComments.length}
Deliverables:          ${newDeliverables.length}
Tribal consultations:  ${newTribal.length}  (Ute Indian Tribe — I-15 Carbon County)
Checklists:            live from NEPA_CHECKLISTS (CE/EA stable keys)
───────────────────────────────────────────────────────
Projects:
